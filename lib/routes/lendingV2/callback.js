  ...
  const notify = (next) => {
    ...
    switch (status) {
      ...
      case 'da_giai_ngan':
        ...
        if(req.query.before_day && parseInt(req.query.before_day) > 0) {
        ...
        if(req.query.overdue_day && parseInt(req.query.overdue_day) > 0) {
        ...
        if(parseInt(req.query.before_day) === 0 && parseInt(req.query.overdue_day) === 0) {
